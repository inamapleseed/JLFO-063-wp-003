...
<div class="footer-top" >
	<div class="container">
		...
		<div class="footer-content cont">
		    ...
		    <?php if(get_field('content_repeater', 'option')):?>
    		    <div class="wustom" style="margin: 15px 0">
        			<div class="footer-content-container">
        			    <h5 style="font-size: 17px !important">Follow Us!</h5>
    		        ...
    		        <?php foreach(get_field('content_repeater', 'option') as $ww): ?>
    		            <h4 style="font-size: 14px !important"><?php echo $ww['header_titlew']; ?></h4>
    		            <div style="display: flex; margin-bottom: 10px">
        		            <img style="background: white; max-width: 25px; margin-right: 8px" src="<?php echo $ww['iconw']; ?>" alt="icon"/>
        		            <?php if($ww['linkw']) :?>
            		            <a href="<?php echo $ww['linkw']; ?>"><?php echo $ww['textw']; ?></a>
            		        <?php else: ?>
            		            <p><?php echo $ww['textw']; ?></p>
            		        <?php endif ?>
    		            </div>
        		    <?php endforeach ?>
    		   </div>
